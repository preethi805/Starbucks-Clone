...
import "../Styles/Frappuccinos.css";

export default function Frappuccino() {
  const products = [
    { id: 1, name: "Caramel Frappuccino", desc: "Smooth & Rich.", img: "./Assets/Caramel Macchiato.png", price: 220 },
    { id: 2, name: "Cream Frappuccino", desc: "Creamy & refreshing.", img: "./Assets/Creamfrap.png", price: 180 },
    { id: 3, name: "Mocha Frappuccino", desc: "Creamy & rich.", img: "./Assets/mocha.webp", price: 200 },
    { id: 4, name: "Javachip Frappuccino", desc: "Bright & mellow.", img: "./Assets/javachipfrap.PNG", price: 190 },
  ];
